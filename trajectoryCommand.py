...
def execute_trajectory(motor: VESC, lengths):
    ...
    displaced_angle = displaced_length * (360 / 200)  # degrees array
...
if __name__ == "__main__":
    ...
    cable_lengths = evaluate_traj(print_details=True)

    execute_trajectory(motor=None, lengths=cable_lengths)
